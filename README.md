...
- создание силлабусов из конструктора или загрузкой готового файла;
...
Если хотите, чтобы AI-проверка файлов и автоматическая смена статуса реально обрабатывались в фоне:
...
- `python manage.py runserver` достаточно для сайта, логина, workflow-интерфейса и AI-ассистента;
- `python manage.py run_worker` обязателен именно для фоновой AI-проверки силлабусов.
...
- `requirements.txt` — базовые зависимости для основного Django-приложения.
- `requirements-ai.txt` — дополнительные зависимости для AI/NLP-сценариев.
